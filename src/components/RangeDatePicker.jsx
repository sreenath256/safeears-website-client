  ...
  return (
    <div className="relative " ref={datePickerRef}>
      <button
        ...
        className="cursor-pointer admin-button-fl bg-white p-3 hover:bg-gray-200 active:bg-gray-300"
      >
        <AiOutlineCalendar />{" "}
      ...
      {showDatePicker && (
        <div className="bg-white px-3 py-2 rounded-lg shadow-2xl absolute right-0 top-10 text-sm z-[9999]">
          <DayPicker
          ...
          <div className="flex gap-2">
            ...
            <button
              className=" bg-red-500  [1px] text-white w-full"
              onClick={() => {
                setStartingDate("");
                setEndingDate("");
                toggleDatePicker();
